      ...
      <div className={styles.container}>
        <div className={styles.headerWrapper}>
          ...
          <div>
            ...
            <p className={styles.headerSubtitle}>
               ...
               'Start building your professional resumes'} </p>
          </div>
          ...
          <div className='flex gap-4'>
            ...
            onClick={() => setOpenCreateModal(true)}>
              ...
              <span className={styles.createButtonContent}>
                Create Now
                <LucideFilePlus className='group-hover:translate-x-1 transition-transform'/>
              </span>
            </button>
          </div>
        </div>
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper}>
            ...
            <p className={styles.emptyText}>You haven't created any resumes yet. Start building professional resumes to land your dream job.</p>

            <button className={styles.createButton} onClick={() => setOpenCreateModal(true)}>
              <div className={styles.createButtonOverlay}></div>
              <p className={styles.createButtonContent}>
        ...
        {!loading && allResumes.length > 0 && (
          <div className={styles.grid}>
            ...
            {allResumes.map((resume) => (
              <ResumeSummaryCard key={resume._id} imgUrl = {resume.thumbnaiLink}
              title={resume.title}
