...
const Tabs = ({ tabs, activeTab, setActiveTab}) => {
  return (
    <div className='w-full my-2'>
      <div className='flex flex-wrap bg-violet-50 p-1 rounded-2xl border-violet-100'>
        {tabs.map((tab) => (
          ...
          ${activeTab ? "bg-white text-violet-700 shadow-lg" : "text-slate-500 hover:text-violet-600 hover:bg-white/50"}`}
