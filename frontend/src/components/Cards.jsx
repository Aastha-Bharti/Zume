    ...
    user && (
      ...
      <div className={cardStyles.profileCard}>
        <div className={cardStyles.profileInitialsContainer}>
          <span className={cardStyles.profileInitialsText +"border border-amber-700"}>
...
export const TemplateCard = ({ thumbnailImage, isSelected , onSelect }) => {
  return (
    ...
    ${
      ...
      { thumbnailImage ? (
        <div className="relative w-full h-full overflow-hidden">
          <img src={thumbnailImage || '/placeholder.svg'} alt="Template Review" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"/>
